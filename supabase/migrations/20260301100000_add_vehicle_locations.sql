-- Migration: Add vehicle locations for Cars & Bikes area
-- Created: 2026-03-01
-- Rollback: Re-run previous constraint migration (20260227200000)
...
ALTER TABLE public.tasks ADD CONSTRAINT tasks_location_check CHECK (
  location IS NULL OR location IN (
    ...
    -- Vehicle locations (Cars & Bikes area)
    'ranger', 'defender', 'gsa', 'mtb',
