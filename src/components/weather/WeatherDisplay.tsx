  ...
  return (
    <div className="space-y-4">
      ...
      {heavyRainDays.length > 0 && (
        <div className="bg-fw-accent/10 border border-amber-300 rounded-xl p-4 flex items-start gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-fw-accent shrink-0 mt-0.5">
      ...
      <div className="bg-fw-surface rounded-xl border border-fw-surface p-5">
        ...
        <div className="flex gap-5 mt-4 text-xs text-fw-text/50">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-fw-text/80 font-medium">{Math.round(current.windSpeed)} km/h</span>
          </div>
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-fw-text/80 font-medium">{current.precipitation} mm</span>
          </div>
          {current.seaTemperature !== null && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-fw-text/80 font-medium">{Math.round(current.seaTemperature)}°C</span>
            </div>
          )}
        </div>
      </div>
                ...
                {daily.map((day, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Tooltip */}
                      {selectedBar === i && (
                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-fw-surface text-white text-xs rounded px-2 py-1 whitespace-nowrap z-10">
      ...
      {/* Rain Radar */}
      <div className="bg-fw-surface rounded-xl border border-fw-surface p-5">
        <p className="text-xs font-medium text-fw-text/50 mb-3">Rain Radar — Wollongong</p>
        <div
          className="relative w-full overflow-hidden rounded-lg bg-fw-bg cursor-pointer"
      ...
      <div className="bg-fw-surface rounded-xl border border-fw-surface p-5">
        ...
        {monthlyComparison.length > 0 && (
          <div className="mt-4 border-t border-fw-surface pt-3">
